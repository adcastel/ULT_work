...
for i in {1..72}; do OMP_NUM_THREADS=$i ./openmp_parallel_for 1000 >> omp_nested_def_1000.dat; done
for i in {1..72}; do OMP_NUM_THREADS=$i ./openmp_parallel_for 5000000 >> omp_nested_def_5000000.dat; done
