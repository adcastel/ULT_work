...
for i in {1..72}; do ./argo_task_ult_pool $i 1000 1 >> argo_op_ult_all_task_1000.dat; done
...
for i in {1..72}; do ./argo_task_ult_single_pool $i 1000 1 >> argo_op_ult_sp_all_task_1000.dat; done
...
for i in {1..72}; do ./argo_task_task_pool $i 1000 1 >> argo_op_task_all_task_1000.dat; done
...
for i in {1..72}; do ./argo_task_task_single_pool $i 1000 1 >> argo_op_task_sp_all_task_1000.dat; done
